...
namespace NursingHome.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240816075241_AddFieldStateInDiseaseCategory")]
    partial class AddFieldStateInDiseaseCategory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MonthlyCalendarDetailShift", b =>
                {
                    ...
                    b.ToTable("MonthlyCalendarDetailShift");
                });
            ...
            modelBuilder.Entity("NursingHome.Domain.Entities.EmployeeSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NursingHome.Domain.Entities.EmployeeType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NursingHome.Domain.Entities.FamilyMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NursingHome.Domain.Entities.MonthlyCalendar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MonthlyCalendars");
                });

            modelBuilder.Entity("NursingHome.Domain.Entities.MonthlyCalendarDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("MonthlyCalendarId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MonthlyCalendarId");

                    b.ToTable("MonthlyCalendarDetails");
                });
            ...
            modelBuilder.Entity("NursingHome.Domain.Entities.ScheduledService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NursingHome.Domain.Entities.ScheduledServiceDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ScheduledServiceId");

                    b.HasIndex("ServicePackageId");

                    b.ToTable("ScheduledServiceDetails");
                });

            modelBuilder.Entity("NursingHome.Domain.Entities.ScheduledTime", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ScheduledServiceDetailId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("ScheduledServiceDetailId");
            ...
            modelBuilder.Entity("NursingHome.Domain.Entities.ServicePackage", b =>
                {
                    ...
                    b.Property<DateOnly?>("EndRegistrationDate")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("MonthlyCalendarDetailShift", b =>
                {
                    b.HasOne("NursingHome.Domain.Entities.MonthlyCalendarDetail", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NursingHome.Domain.Entities.EmployeeSchedule", b =>
                {
                    ...
                    b.HasOne("NursingHome.Domain.Entities.EmployeeType", "EmployeeType")
                        .WithMany("EmployeeSchedules")
            ...
            modelBuilder.Entity("NursingHome.Domain.Entities.MonthlyCalendarDetail", b =>
                {
                    b.HasOne("NursingHome.Domain.Entities.EmployeeType", "EmployeeType")
                        .WithMany("MonthlyCalendarDetails")
                        .HasForeignKey("EmployeeTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NursingHome.Domain.Entities.MonthlyCalendar", "MonthlyCalendar")
                        .WithMany("MonthlyCalendarDetails")
                        .HasForeignKey("MonthlyCalendarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("EmployeeType");

                    b.Navigation("MonthlyCalendar");
                });
            ...
            modelBuilder.Entity("NursingHome.Domain.Entities.ScheduledServiceDetail", b =>
                {
                    b.HasOne("NursingHome.Domain.Entities.Elder", "Elder")
                        .WithMany("ScheduledServiceDetails")
                        .HasForeignKey("ElderId");

                    b.HasOne("NursingHome.Domain.Entities.ScheduledService", "ScheduledService")
                        .WithMany("ScheduledServiceDetails")
            ...
            modelBuilder.Entity("NursingHome.Domain.Entities.ScheduledTime", b =>
                {
                    b.HasOne("NursingHome.Domain.Entities.ScheduledServiceDetail", "ScheduledServiceDetail")
                        .WithMany("ScheduledTimes")
                        .HasForeignKey("ScheduledServiceDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ScheduledServiceDetail");
                });
            ...
            modelBuilder.Entity("NursingHome.Domain.Entities.Elder", b =>
                {
                    ...
                    b.Navigation("ScheduledServiceDetails");
                });
            ...
            modelBuilder.Entity("NursingHome.Domain.Entities.EmployeeType", b =>
                {
                    ...
                    b.Navigation("MonthlyCalendarDetails");
                });
